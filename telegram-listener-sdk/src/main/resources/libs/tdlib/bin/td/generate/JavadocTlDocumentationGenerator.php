...
namespace libs\tdlib\bin\td\generate;

use libs\build\bin\td\generate\TlDocumentationGenerator;
...
$generator = new \libs\tdlib\bin\td\generate\JavadocTlDocumentationGenerator($nullable_type, $nullable_annotation, $java_version);
